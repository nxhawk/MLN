...
def generate_population(population_size: int, chromosome_size: int, mutation_probability: float, old_population: list[list[int]], fitness_values: list[int]) -> list[list[int]]:
    """
    ...
    for _ in range(population_size//2):
        # select two parent to crossover them
        parent1 = roulette_wheel_selection(old_population, fitness_values)
        parent2 = roulette_wheel_selection(old_population, fitness_values)

        # new generation of (parent1, parent2)
